...
#define SORT_BY(field)  [](const auto &lhs, const auto &rhs) {return lhs.field < rhs.field;}// Реализуйте этот макрос, а также необходимые операторы для классов Date и Time
